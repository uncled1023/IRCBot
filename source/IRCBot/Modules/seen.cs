...
namespace IRCBot
{
    class seen
    {
        public void seen_control(string[] line, string command, bot ircbot, int nick_access, string nick, StreamReader sr)
        {
            switch (command)
            {
                case "seen":
        ...
        private void display_seen(string nick, string channel, bot ircbot, StreamReader sr)
        {
