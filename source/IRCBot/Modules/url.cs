                        ...
                        switch (content_type[0])
                        {
                            case "text":
                                ...
                                if (url.OriginalString.Contains("youtube.com/watch?") && ircbot.conf.module_config[module_id][4].Equals("True"))
                                {
                                    ...
                                    ircbot.sendData("PRIVMSG", channel + " :[Youtube] Title: " + yt_title + " | Length: " + total_duration.TrimEnd(' ') + " | Views: " + views.ToString() + " | Rated: " + Math.Round(rateavg, 2).ToString() + "/5.0 | Uploaded By: " + uploader + " on " + date.ToString("yyyy-MM-dd"));
                                }
                                ...
                                {
                                    ircbot.sendData("PRIVMSG", channel + " :[URL] " + title + " (" + url.Host.ToLower() + ")");
                                }
                                break;
                            case "image":
                            ...
                            default:
                                ...
                                {
                                    ircbot.sendData("PRIVMSG", channel + " :[URL] " + response.ContentType + " (" + url.Host.ToLower() + ")");
                                }
                                break;
                        }
